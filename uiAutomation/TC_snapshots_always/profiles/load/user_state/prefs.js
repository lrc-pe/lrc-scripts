...
user_pref("LoadRunner.config.user_dir", "C:\\Users\\Administrator\\Desktop\\Scripts\\Snapshots\\snapshots_always_FF");
...
user_pref("TC.Global.SidebarWidth", 522);
...
user_pref("browser.slowStartup.averageTime", 2639);
...
user_pref("datareporting.healthreport.nextDataSubmissionTime", "1479533634113");
...
user_pref("datareporting.policy.firstRunTime", "1479447234112");
user_pref("datareporting.sessions.current.activeTicks", 7);
user_pref("datareporting.sessions.current.firstPaint", 2445);
user_pref("datareporting.sessions.current.main", 434);
user_pref("datareporting.sessions.current.sessionRestored", 2792);
user_pref("datareporting.sessions.current.startTime", "1479447232858");
...
user_pref("toolkit.startup.last_success", 1479447233);
